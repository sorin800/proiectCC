...
public class Logare extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       User user = MainService.getInstance().login(nume, parola);
        if(user!=null){
            new MainFrame();
            this.dispose();
        }else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(MainService.getInstance().inregistrare(user)){
            JOptionPane.showMessageDialog(null, "Userul a fost inregistrat cu succes!");
        }else{
            JOptionPane.showMessageDialog(null, "Eroare de inregistrare!");
        }
