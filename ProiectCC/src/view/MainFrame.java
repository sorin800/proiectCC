...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String facultate = jTextField2.getText();
        String specializare = jTextField3.getText();
        String email = jTextField3.getText();
        Student s = new Student(nume, facultate, specializare, email);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Student s = jList1.getSelectedValue();
                    MainService.getInstance().stergeStudent(s.getId());
                    afisareStudenti();
